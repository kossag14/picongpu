...
class PhaseSpaceMeta(object):
    ...
    def __init__(self, species, species_filter, ps_x, shape, extent, dV):
        """
        Parameters
        ----------
        species : string
...
class PhaseSpace(object):
    ...
    def get_data_path(self, species, species_filter, ps_x, iteration=None):
        """
    ...
    def get_iterations(self, species, species_filter='all', ps_x=None):
        """
        ...
        """
        data_file_path = self.get_data_path(species, species_filter, ps_x)
    ...
    def get(self, species, species_filter='all', iteration=None, ps_x=None,
            **kwargs):
        """
        ...
        available_iterations = self.get_iterations(species, species_filter, ps_x)
        ...
        ps_meta = PhaseSpaceMeta(species, species_filter, ps_x, ps_cut.shape,
                                 extent, dV)
