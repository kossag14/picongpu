    ...
    def main():
        ...
        try:
            opts, args = getopt.getopt(sys.argv[1:], "hp:i:s:f:a:o:", [
                "help", "path", "iteration", "species", "filter", "axisyz",
                "offset"])
        ...
        if axisyz is None:
            axisyz = "yz"
            print("Axis was not given, will use", axisyz)
        ...
        Visualizer(path).visualize(ax, iteration=iteration, species=species,
                                   species_filter=filtr, axisyz=axisyz,
