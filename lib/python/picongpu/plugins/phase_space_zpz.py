...
class PhaseSpaceMeta(object):
    ...
    def __init__(self, species, species_filter, ps_z, shape, extent, dV):
        """
        Parameters
        ----------
        species : string
...
class PhaseSpace(object):
    ...
    def get_data_path(self, species, species_filter, ps_z, iteration=None):
        """
    ...
    def get_iterations(self, species, species_filter='all', ps_z=None):
        """
        ...
        """
        data_file_path = self.get_data_path(species, species_filter, ps_z)
    ...
    def get(self, species, species_filter='all', iteration=None, ps_z=None,
            **kwargs):
        """
        ...
        available_iterations = self.get_iterations(species, species_filter, ps_z)
        ...
        ps_meta = PhaseSpaceMeta(species, species_filter, ps_z, ps_cut.shape,
                                 extent, dV)
